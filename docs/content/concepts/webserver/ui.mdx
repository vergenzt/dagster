...
<!-- ![The Catalog views dropdown in the Dagster+ Pro Catalog UI](/images/concepts/webserver/catalog-views.png) -->

<Image
alt="The Catalog views dropdown in the Dagster+ Pro Catalog UI"
src="/images/concepts/webserver/catalog-views.png"
width={3429}
height={1990}
/>
...
- **Description**: The **Schedule details** page contains details about a single schedule, including its next tick, tick history, and run history. Clicking the **Manual Tick** button near the top right corner of the page allows you to test the schedule.
...
- **Description**: The **Sensor details** page contains details about a single sensor, including its next tick, tick history, and run history. Clicking the **Manual Tick** button near the top right corner of the page allows you to test the sensor.
